...
import com.example.mvvmdeliverycloneapp.databinding.ActivityRestaurantDetailBinding
import com.example.mvvmdeliverycloneapp.extensions.fromDpToPx
...
import com.example.mvvmdeliverycloneapp.screen.main.home.restaurant.detail.review.RestaurantReviewListFragment
...
import com.example.mvvmdeliverycloneapp.widget.adapter.RestaurantDetailListFragmentPagerAdapter
                ...
                if (firebaseAuth.currentUser == null){
                    ...
                    alertLoginNeed {
                        lifecycleScope.launch {
                            menuChangeEventBus.changeMenu(MainActivity.MainTabMenu.MY)
                            finish()
                        }
                    }
                }else{
